...
2. Define a clearer day-level plan contract.

Each day should explicitly specify structured fields such as:
...
3. Keep the current deterministic philosophy.
   ...
   - Preserve the current credible step-by-step weekly progression.
   - Maintain specificity through later days of the plan.
...
1. Do **not** switch to “LLM writes the full weekly plan.”
