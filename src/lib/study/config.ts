...
export const STUDY_PLAN_DRAFT_KEY = "tennislevel_study_plan_draft";
...
export const PENDING_SURVEY_SESSION_KEY = "tennislevel_pending_survey_session";
...
export const STUDY_SNAPSHOT_VERSION = readPublicEnv("NEXT_PUBLIC_STUDY_SNAPSHOT_VERSION", "2026-03-31-v1");
